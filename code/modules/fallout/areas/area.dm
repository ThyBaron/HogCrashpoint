...
//	var/ambience_area =  list('sound/f13ambience/wasteland.ogg')
	var/ambientsounds = list('sound/misc/null.ogg')//doesn't /really/ do anything currently
	var/environment = -1
	var/grow_chance = 100
	var/blob_allowed = 0//doesn't do anything currently
	var/outdoors = 0//doesn't do anything currently
